        ...
        private void ButtonRegister_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string url = "http://192.168.5.94/IT123P/REST/register_table.php?uname=" + Uri.EscapeDataString(uname) + "&pword=" + Uri.EscapeDataString(pword) + "&usermail=" + Uri.EscapeDataString(usermail);
