    ...
    public class ForgotPass_Activity : Activity
    {
        ...
        private void userCheck (object sender, EventArgs e)
        {
            try
            {
                ...
                // Create a request
                var request = (HttpWebRequest)WebRequest.Create("http://192.168.68.104/IT123P/REST/user_forgot.php?usermail=" + email.Text);
        ...
        private void ChangePassword(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string url = "http://192.168.68.104/IT123P/REST/update_password.php?usermail=" + email.Text + "&newpass=" + password.Text;
